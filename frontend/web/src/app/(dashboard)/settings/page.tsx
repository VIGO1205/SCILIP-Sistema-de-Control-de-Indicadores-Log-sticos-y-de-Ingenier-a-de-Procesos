  ...
  return (
    <main className="p-4 sm:p-5 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <TabGroup className="mt-6">
        <TabList className="bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-900/20 dark:via-purple-900/20 dark:to-pink-900/20 rounded-t-xl border border-indigo-100/50 dark:border-indigo-900/30 border-b-0 shadow-sm p-1.5 gap-1.5 flex-wrap">
          <Tab icon={User} className="px-3 py-2.5 text-xs font-medium text-gray-500 dark:text-dark-tremor-content-subtle hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-white/60 dark:hover:bg-dark-tremor-background-subtle rounded-lg transition-all duration-300 data-[selected]:text-indigo-600 dark:data-[selected]:text-indigo-400 data-[selected]:font-bold data-[selected]:border-b-[3px] data-[selected]:border-indigo-500">Perfil</Tab>
          <Tab icon={Building2} className="px-3 py-2.5 text-xs font-medium text-gray-500 dark:text-dark-tremor-content-subtle hover:text-blue-600 dark:hover:text-blue-400 hover:bg-white/60 dark:hover:bg-dark-tremor-background-subtle rounded-lg transition-all duration-300 data-[selected]:text-blue-600 dark:data-[selected]:text-blue-400 data-[selected]:font-bold data-[selected]:border-b-[3px] data-[selected]:border-blue-500">Empresa</Tab>
          <Tab icon={Bell} className="px-3 py-2.5 text-xs font-medium text-gray-500 dark:text-dark-tremor-content-subtle hover:text-purple-600 dark:hover:text-purple-400 hover:bg-white/60 dark:hover:bg-dark-tremor-background-subtle rounded-lg transition-all duration-300 data-[selected]:text-purple-600 dark:data-[selected]:text-purple-400 data-[selected]:font-bold data-[selected]:border-b-[3px] data-[selected]:border-purple-500">Notificaciones</Tab>
          <Tab icon={Shield} className="px-3 py-2.5 text-xs font-medium text-gray-500 dark:text-dark-tremor-content-subtle hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-white/60 dark:hover:bg-dark-tremor-background-subtle rounded-lg transition-all duration-300 data-[selected]:text-emerald-600 dark:data-[selected]:text-emerald-400 data-[selected]:font-bold data-[selected]:border-b-[3px] data-[selected]:border-emerald-500">Seguridad</Tab>
          <Tab icon={Database} className="px-3 py-2.5 text-xs font-medium text-gray-500 dark:text-dark-tremor-content-subtle hover:text-amber-600 dark:hover:text-amber-400 hover:bg-white/60 dark:hover:bg-dark-tremor-background-subtle rounded-lg transition-all duration-300 data-[selected]:text-amber-600 dark:data-[selected]:text-amber-400 data-[selected]:font-bold data-[selected]:border-b-[3px] data-[selected]:border-amber-500">Sistema</Tab>
        </TabList>
