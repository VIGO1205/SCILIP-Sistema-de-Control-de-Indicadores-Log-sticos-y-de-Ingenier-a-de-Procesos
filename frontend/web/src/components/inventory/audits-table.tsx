    ...
    return (
      <Card className="border border-gray-200 shadow-sm rounded-xl">
        <div className="flex items-center gap-2 mb-4 pb-3 border-b border-gray-100">
          ...
          <h3 className="text-sm font-bold text-gray-900">Auditorías Físicas</h3>
        </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-gray-50/80 border-b border-gray-100">
              ...
              <th className="text-right px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Teórico</th>
              <th className="text-right px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Físico</th>
              <th className="text-right px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Diferencia</th>
            ...
            {paginatedAudits.map((audit) => {
              ...
              return (
                <tr key={audit.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-gray-900 font-medium">{audit.product?.name || '-'}</td>
                  <td className="px-4 py-3 text-gray-600">{audit.warehouse?.name || '-'}</td>
                  <td className="px-4 py-3 text-right text-gray-600">{audit.theoreticalQuantity ?? 0}</td>
                  <td className="px-4 py-3 text-right text-gray-900 font-semibold">{audit.physicalQuantity ?? 0}</td>
