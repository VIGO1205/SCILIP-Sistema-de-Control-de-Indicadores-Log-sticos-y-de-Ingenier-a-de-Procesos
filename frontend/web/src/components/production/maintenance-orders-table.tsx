...
const statusMap: Record<string, { label: string; class: string; icon: any }> = {
  ...
  cancelled: { label: 'Cancelada', class: 'bg-gray-50 text-gray-700 border border-gray-200', icon: XCircle },
};
    ...
    return (
      <Card className="border border-gray-200 shadow-sm rounded-xl">
        <div className="flex items-center gap-2 mb-4 pb-3 border-b border-gray-100 px-5 pt-5">
          ...
          <h3 className="text-sm font-bold text-gray-900">Órdenes de Mantenimiento</h3>
        </div>
        <div className="flex flex-col items-center justify-center p-12 bg-gradient-to-br from-white to-gray-50/50 rounded-lg border border-dashed border-gray-200">
          ...
          <p className="text-gray-500 font-medium">No hay órdenes de mantenimiento</p>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-gray-50/80 border-b border-gray-100">
              ...
              <th className="text-center px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Prioridad</th>
              ...
              return (
                <tr key={order.id} className="hover:bg-gray-50/50 transition-colors">
                  <td className="px-4 py-3">
                    <div className="font-medium text-gray-900 text-xs">{order.title}</div>
