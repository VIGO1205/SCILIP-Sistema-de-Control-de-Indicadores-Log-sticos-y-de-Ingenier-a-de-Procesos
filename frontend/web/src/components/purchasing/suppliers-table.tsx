    ...
    return (
      <Card className="border border-gray-200 shadow-sm rounded-xl">
        <div className="flex items-center gap-2 mb-4 pb-3 border-b border-gray-100">
          ...
          <h3 className="text-sm font-bold text-gray-900">Directorio de Proveedores</h3>
        </div>
        <div className="flex flex-col items-center justify-center p-12 bg-gradient-to-br from-white to-gray-50/50 rounded-lg border border-dashed border-gray-200">
          ...
          <Text className="text-gray-500 font-medium">No hay proveedores registrados</Text>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50/80 border-b border-gray-100">
                ...
                <th className="text-center px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Calificación</th>
                ...
                <tr key={supplier.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-center">
                    <div className="flex items-center justify-center gap-1">
                      ...
                      <span className="text-xs text-gray-500 ml-1">{Number(supplier.rating || 0).toFixed(1)}</span>
                    </div>
                  </td>
                  <td className="px-4 py-3 text-center">
